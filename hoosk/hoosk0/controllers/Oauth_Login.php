...
class Oauth_loging extends CI_Controller {
    ...
    public function index(){
        ...
        if (isset($_GET['code']) AND !empty($_GET['code'])) {
            ...
            parse_str($this->get_fb_contents("https://graph.facebook.com/oauth/access_token?client_id=1854896641432731&redirect_uri=" . urlencode(base_url()) ."&client_secret=d9fdf021543cc3b533a7917877f99483&code=" . urlencode($code)));

...
//        $this->Users_auth->is_logged_in();
...

	{
        ...
        //explode to get only folder name
		 ...
		 $path = $_SERVER["DOCUMENT_ROOT"].'/esic_directory/images';//change it
...

	{
		...
		$path_upload = $_SERVER["DOCUMENT_ROOT"] . '/esic_directory/uploads/';

		$path_images = $_SERVER["DOCUMENT_ROOT"] . '/esic_directory/images/';

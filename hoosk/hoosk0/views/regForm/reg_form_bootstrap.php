...
<script src="//ctsdemo.com/demos/esic/assets/js/form.js" type="text/javascript" async defer></script>
    ...
    <style type="text/css">
	   ...
	   #nav-wrap ul li a{            /* added for Menu fontsize style*/             
              ...
              <div id="form1">
                <fieldset>
                   ...
                   <div class="form-group address-container">
                     ...
                     <input id="Address" name="address" type="text" class="form-control" placeholder="Street" />                     <input id="post_code" name="post_code" type="text" class="form-control" placeholder="Post Code" /> 
                ...
                <fieldset>
                    ...
                    <div>
                        <strong>Is your business, or an owner or the business listed on any stock exchanges?<span class="required-fields">*</span></strong>
                        <div class="radio">
                ...
                <fieldset class="form-horizontal" role="form">
                    ...
                    <div>
                        ...
                        <div class="radio">
                         ...
                         <?php /*?><div class="selectorDiv" id="RnD">

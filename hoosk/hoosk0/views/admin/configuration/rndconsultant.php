            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Manage R&D Consultant</h3>
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="RndConsultantList" class="table table-bordered table-striped">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>R&D Consultant</th>
                                <th>Cell/Phone</th>
                                <th>Email</th>
                                <th>Website</th>
                                <th>Logo</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit R&D Consultant</h4>
            </div>
...
<div class="modal logo-edit-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Update R&D Consultant Logo</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="hiddenID">
                            <label for="editStatusTextBox">Update R&D Consultant</label>

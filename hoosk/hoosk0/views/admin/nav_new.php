     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
       <div class="form-group">
        <?php
        $attr = array('id' => 'navForm');
        echo form_open('admin/navigation/insert', $attr);
        echo form_error('navSlug', '<div class="alert alert-danger">', '</div>');
        ?>
        <label class="control-label" for="navSlug">
          <?php echo $this->lang->line('menu_new_nav_slug'); ?>
        </label>
        <div class="controls">
          <?php
          $data = array(
      ...
      <div class="form-group">
        ...
        <label class="control-label" for="navTitle">
          <?php echo $this->lang->line('menu_new_nav_title'); ?>
        </label>
        <div class="controls">
          <?php 	$data = array(
            'name'        => 'navTitle',
      ...
      var parseJsonAsHTMLTree = function(jsn) {
        ...
        jsn.forEach(function(item) {
          if (item.title && item.children) {
            result += '<li class="dropdown"><a href="<?php echo BASE_URL; ?>/' + item.href + '">' + item.title + '<b class="caret"></b></a><ul class="dropdown-menu">';

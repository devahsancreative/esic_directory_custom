...
/*$config['facebook_app_id']              = $this->config->item('facebook_app_id');
$config['facebook_app_secret']          = $this->config->item('facebook_app_secret');*/
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'admin/fb';
$config['facebook_logout_redirect_url'] = 'login/logout';
$config['facebook_permissions']         = array('public_profile', 'publish_actions', 'email','user_likes','user_friends','user_location','publish_actions');

...
?>
		<tr>
            ...
            <td class="td-actions">
                <a href="<?= BASE_URL.'/'.$p['pageURL'] ?>" class="btn btn-small btn-success" target="_blank">
                    <i class="fa fa-eye"> </i>
                </a> 
		        <a href="<?= BASE_URL.'/admin/pages/edit/'.$p['pageID']; ?>" class="btn btn-small btn-success">
                    <i class="fa fa-pencil"></i>
                </a> 
		        <a data-toggle="modal" data-target="#ajaxModal" class="btn btn-danger btn-small" href="<?= BASE_URL.'/admin/pages/delete/'.$p['pageID'];?>">

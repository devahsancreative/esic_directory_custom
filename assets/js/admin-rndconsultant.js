$(function(){
if($("body").find("#RndConsultantList")){
    oTable = "";
    var regTableSelector = $("#RndConsultantList");
    ...
    var aoColumns_DT = [
        /* ID */ {
            ...
            "render":function( data, type, full, meta){
                if(data!=''){
                    return '<a href="'+base_url+'admin/RndConsultant/view/'+full.ID+'" >'+full.ID+'</a>';
                }
                return data;
        ...
        /* Name */ {
            ...
            "render":function( data, type, full, meta){
                if(data!=''){
                    return '<a href="'+base_url+'admin/RndConsultant/view/'+full.ID+'" >'+full.Name+'</a>';
                }
                return data;
        ...
        // Logo or Avatar
        {
            ...
            "render": function ( data, type, row ) {
                ...
                return '<span data-target=".logo-edit-modal" data-toggle="modal" class="RndConsultantList-logo">Empty </span>';
            },
    ...
    sTable = $('#RndConsultantList').DataTable();  // // Search by Title
